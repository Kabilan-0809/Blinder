...
def set_goal(session_id: str, goal: str):
...
def add_observation(session_id: str, description: str):
...
def complete_goal(session_id: str):
    mem = get_memory(session_id)
    mem["task_status"] = "completed"
    
def pause_task(session_id: str, question: str):
    mem = get_memory(session_id)
